...
public class UserPracTres{
	public static void main(String[] args) {
		...
		try{
			File archi = new File("prueba3.txt");	//abrir archivo
			...
			//set.completar(states, alphabet);	//función para completar el set de transiciones	*¿Necesario para p3?*
			/*	//Lo siguiente es para reimprimir el autómata dado por el txt, se imprime completado si se uso set.completar(x,x);
			System.out.print("Q : ");
			...
			*/
			AFD bolt = new AFD(alphabet.dameelarraywe());
			bolt.crear(states, finalstates, initialstate.singleelement(0), set);
			bolt.imprimirTabla();
			/*
